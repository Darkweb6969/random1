...
const PRODUCTS = [
  // TRAVEL BAGS
  {id:1,cat:'travel',name:'Weekender Duffel Pro',meta:'Travel Bag · Canvas',price:2499,old:3299,badge:'Best Seller',img:'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=700&q=80',desc:'The ultimate carry-on companion. 40L capacity, waterproof 1000D canvas, padded laptop sleeve and shoe compartment. Perfect for 3–5 day trips.',colors:['#1B2E42','#4A3520','#3A5A3A','#C95F3A'],reviews:284,sizes:['One Size']},
  {id:2,cat:'travel',name:'Cabin Carry-All',meta:'Travel Bag · Nylon',price:1899,badge:'New',img:'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=700&q=80',desc:'Slim, airline-approved overhead cabin bag in waterproof ripstop nylon. Fits under seat or overhead. Ideal as a second bag with your trolley.',colors:['#1B2E42','#0A1520','#4A3520'],reviews:132,sizes:['One Size']},
  {id:3,cat:'travel',name:'Explorer Duffel 60L',meta:'Travel Bag · Ballistic Nylon',price:3299,old:4499,badge:'Sale',img:'https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?w=700&q=80',desc:'For the serious traveller. 60L military-grade ballistic nylon with lockable zippers, detachable shoulder strap, and compression straps.',colors:['#3A5A3A','#1B2E42','#4A3520'],reviews:97,sizes:['60L']},
  {id:4,cat:'travel',name:'Slim Travel Tote',meta:'Travel Bag · Canvas',price:1499,badge:'',img:'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=700&q=80',desc:'A structured travel tote that doubles as a chic everyday bag. Reinforced base, internal organiser pockets, and a trolley sleeve.',colors:['#D4C0A0','#1B2E42','#C95F3A'],reviews:215,sizes:['One Size']},

  // TROLLEYS
  {id:5,cat:'trolley',name:'AeroShell Cabin Trolley 20"',meta:'Trolley · ABS+PC Hardshell',price:4499,old:5999,badge:'Best Seller',img:'https://images.unsplash.com/photo-1581553680321-4fffae59fccd?w=700&q=80',desc:'Cabin-approved 20" hardshell spinner. 360° silent spinner wheels, TSA-approved combination lock, telescoping aluminium handle. Weighs just 2.6kg.',colors:['#1B2E42','#C95F3A','#4A7A8A','#2E3A2E'],reviews:456,sizes:['20" Cabin']},
  {id:6,cat:'trolley',name:'AeroShell Medium 24"',meta:'Trolley · ABS+PC Hardshell',price:5499,badge:'New',img:'https://images.unsplash.com/photo-1581553680321-4fffae59fccd?w=700&q=80',desc:'The 24" sweet spot — fits most airline holds with room to spare. Expandable zip adds 15% extra packing space. Same premium spinner as our cabin bag.',colors:['#1B2E42','#C95F3A','#8A3A3A'],reviews:198,sizes:['24" Medium']},
  {id:7,cat:'trolley',name:'AeroShell Large 28"',meta:'Trolley · ABS+PC Hardshell',price:6499,old:7999,badge:'Sale',img:'https://images.unsplash.com/photo-1581553680321-4fffae59fccd?w=700&q=80',desc:'Long-haul luxury. The 28" spinner fits everything for 2-week adventures. Built-in laundry bag, compression straps, and a removable garment divider.',colors:['#1B2E42','#C95F3A','#3A5A3A'],reviews:143,sizes:['28" Large']},
  {id:8,cat:'trolley',name:'Soft-Shell Trolley Set',meta:'Trolley Set · 3 Piece',price:8999,old:12999,badge:'Best Seller',img:'https://images.unsplash.com/photo-1581553680321-4fffae59fccd?w=700&q=80',desc:'The complete set — cabin, medium, and large soft-shell trolleys in matching design. YKK zippers, TSA locks, and silent spinner wheels on all three.',colors:['#1B2E42','#C95F3A','#D4C0A0'],reviews:89,sizes:['Set of 3']},

  // HANDBAGS
  {id:9,cat:'handbag',name:'Leather Structured Tote',meta:'Handbag · Full-Grain Leather',price:3999,old:5499,badge:'Best Seller',img:'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=700&q=80',desc:'Full-grain vegetable-tanned leather tote. Fits a 13" laptop. Brass hardware, suede interior, magnetic closure. Gets better with every use.',colors:['#4A3520','#1B2E42','#8A3A3A'],reviews:312,sizes:['One Size']},
  {id:10,cat:'handbag',name:'Canvas Crossbody Sling',meta:'Handbag · Waxed Canvas',price:1699,badge:'New',img:'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=700&q=80',desc:'Lightweight waxed canvas sling with adjustable strap. Three compartments, anti-theft back pocket. Perfect for commutes, markets, and day trips.',colors:['#4A3520','#1B2E42','#3A5A3A'],reviews:178,sizes:['One Size']},
  {id:11,cat:'handbag',name:'Mini Leather Clutch',meta:'Handbag · Leather',price:1299,badge:'',img:'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=700&q=80',desc:'Evening-ready genuine leather clutch with detachable chain strap. Fits phone, cards, and essentials. Gold-tone hardware.',colors:['#4A3520','#8A3A3A','#1B2E42','#D4B080'],reviews:220,sizes:['One Size']},
  {id:12,cat:'handbag',name:'Shopper Tote XL',meta:'Handbag · Canvas',price:999,old:1499,badge:'Sale',img:'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=700&q=80',desc:'The everyday workhorse. Reinforced canvas that holds up to 15kg. Internal zip pocket, exterior slip pocket. Folds flat for storage.',colors:['#D4C0A0','#1B2E42','#C95F3A'],reviews:445,sizes:['One Size']},

  // RUCKSACKS
  {id:13,cat:'rucksack',name:'Himalaya 40L Hiking Pack',meta:'Rucksack · Waterproof Nylon',price:3499,old:4999,badge:'Best Seller',img:'https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=700&q=80',desc:'Engineered for serious trails. 40L waterproof hiking pack with ventilated back panel, padded hip belt, rain cover, and hydration system compatibility.',colors:['#3A5A3A','#1B2E42','#C95F3A'],reviews:387,sizes:['40L']},
  {id:14,cat:'rucksack',name:'Urban Laptop Rucksack',meta:'Rucksack · Canvas + Leather',price:2299,badge:'New',img:'https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?w=700&q=80',desc:'Clean, city-ready 25L rucksack with a padded 15" laptop sleeve, USB charging port, and waxed canvas exterior. Goes from work to weekend seamlessly.',colors:['#4A3520','#1B2E42','#3A5A3A'],reviews:241,sizes:['25L']},
  {id:15,cat:'rucksack',name:'Trail Mini 20L',meta:'Rucksack · Ripstop Nylon',price:1799,old:2499,badge:'Sale',img:'https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=700&q=80',desc:'Light and agile 20L daypack for day hikes, travel, and school. Hydration sleeve, trekking pole loops, reflective strips. Only 450g.',colors:['#C95F3A','#3A5A3A','#1B2E42'],reviews:166,sizes:['20L']},
  {id:16,cat:'rucksack',name:'Executive Slim Pack',meta:'Rucksack · Faux Leather',price:2799,badge:'',img:'https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?w=700&q=80',desc:'Sleek 20L executive rucksack with vegan leather panel, hidden anti-theft pocket, padded laptop slot, and organisational pen + card slots.',colors:['#1B2E42','#0A1520','#4A3520'],reviews:194,sizes:['20L']},
];

const BUNDLES = [
  {id:'b1',icon:'✈️',name:'The Jet-Setter Bundle',price:8999,desc:'Everything a frequent flyer needs, beautifully packaged.',items:['AeroShell Cabin Trolley 20"','Weekender Duffel Pro','Canvas Crossbody Sling','TSA Luggage Strap + Tag Set'],img:'https://images.unsplash.com/photo-1581553680321-4fffae59fccd?w=600&q=80'},
  {id:'b2',icon:'⛰️',name:'The Adventure Bundle',price:5999,desc:'Built for trails, mountain roads, and off-grid weekends.',items:['Himalaya 40L Hiking Pack','Explorer Duffel 60L','Trail Mini 20L','Waterproof Packing Cubes'],img:'https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=600&q=80'},
  {id:'b3',icon:'💼',name:'The Business Traveller',price:7499,desc:'Power through airports and meetings with one cohesive set.',items:['AeroShell Medium 24"','Executive Slim Pack','Leather Structured Tote','Cable Organiser Pouch'],img:'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=600&q=80'},
  {id:'b4',icon:'🎒',name:'The Student Bundle',price:2999,old:4299,desc:'The complete back-to-college kit. Everything you need.',items:['Urban Laptop Rucksack','Canvas Crossbody Sling','Shopper Tote XL','Pencil Case & Accessories'],img:'https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?w=600&q=80'},
  {id:'b5',icon:'🌴',name:'The Weekend Escape',price:4299,desc:'Pack in 20 minutes and go. Everything for a 3-day trip.',items:['Weekender Duffel Pro','Trail Mini 20L','Mini Leather Clutch','Toiletry + Packing Cubes'],img:'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&q=80'},
  {id:'b6',icon:'🎁',name:'Custom Gift Bundle',price:3999,desc:'Hand-pick 3 items from our catalogue, we\'ll pack and gift them.',items:['Choose any 3 items','Custom engraving available','Premium gift wrapping','Handwritten note card'],img:'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&q=80'},
];
